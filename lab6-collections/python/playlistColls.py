...
piecesFromThings = [i for i in things if i.__class__==Piece] #TASK 6.2-c -- replace "todo" by a list comprehension
...
shortItemLenghts1 = [i.length_secs for i in playlist1 if i.length_secs < 20] # TASK 6.2-b -- replace "todo" by a list comprehension
